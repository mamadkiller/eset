   ...
   -----------------------------------------------------------------------------------------------
	...
	-----------------------------------------------------------------------------------------------
  	if text:match("^[Ss]hare$") and is_sudo(msg) then
       sendContact(msg.chat_id_, msg.id_, 0, 1, nil, 989302555978, '#killer', '021', 158955285)
    end
	-----------------------------------------------------------------------------------------------
...
Developer @mamadkiller  *]]
   ...
   -----------------------------------------------------------------------------------------------
      if text:match("^[Pp]ayping$") and is_sudo(msg) then
        send(msg.chat_id_, msg.id_, 1, 'https://payping.ir/mamadkiller', 1, 'html')
   end
  end
  -----------------------------------------------------------------------------------------------
 end 
